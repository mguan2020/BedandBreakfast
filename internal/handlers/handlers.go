...
func (m *Repository) Reservation(w http.ResponseWriter, r *http.Request) {
	...
	m.App.InfoLog.Println(res.RoomID)
...
// take URL params, build session variable, take user to make reservation page
...
func (m *Repository) PostShowLogin(w http.ResponseWriter, r *http.Request) {
	...
	m.App.Session.Put(r.Context(), "flash", "user logged in successfully")
